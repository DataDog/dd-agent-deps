...
Name:		python26-Percona
Version:	1.2.3
Release:	1%{?dist}
Summary:	An interface to Percona Server
License:	GPLv2+
...
BuildRequires: %{__python}-devel %{__python}-setuptools
BuildRequires: mysql-devel zlib-devel


%description
Python interface to Percona's version of MySQL
...
%changelog
* Sat Oct 15 2011 Datadog, Inc. <package@datadoghq.com> - 1.2.3-1
- Adapted from python-MySQL to support Percona
